...
{                                                          // Line 6
  ...
  int index;                                               // Line 9
  int number;                                              // Line 10
  cout << "List 11: Processing the integer list" << endl;  // Line 11
  ...
  cout << "Line 47: Processing the integer list" << endl;     // Line 47
  cout << "Line 48: Enter " << intListSize << " integers: ";  // Line 48
  ...
  cout << "Line 62: Length of intList2: " << intList2.getLength()
       << endl;  // Line 62
  cout << "Line 63: Maximum size of intList2: " << intList2.getMaxSize()
       << endl;  // Line 63
  return 0;      // Line 64
}
