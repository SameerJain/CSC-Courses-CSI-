...
int main() {
  ...
  copyStack =
      stack;  // copy stack into copyStack using the overloaded operator =
  ...
  if (!stack.isEmptyStack()) {
    cout << "The original stack is not empty." << endl
         << "The top element of the original stack: " << stack.top() << endl;
    cout << "The copyStack's top element is the same: " << copyStack.top()
         << endl;
  }
