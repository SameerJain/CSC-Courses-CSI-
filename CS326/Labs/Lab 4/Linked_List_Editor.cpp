...
int main() {
  ...
  cout << "********************************" << endl;
  cout << "Select the operation you would like to perform on the Sorted Singly "
          "Linked List!  "
       << endl
       << endl;
  ...
  while (true) {
    ...
    cout
        << "4) Find the position of the element which is the same as the key\n";
    cout << "5) Insert a value to the right postion of the sorted linked list "
            "ALLOWING FOR DUPLICATE\n";
    cout << "6) Insert WITHOUT allowing for duplicate element of the linked "
            "list\n";
