// Selection Sort
// =================================================================
void selectionSortA(int arr[], int n) {  // selection sort algorithm
  for (int i = 0; i < n; i++) {
    int smallest = i;
    for (int j = i; j < n; j++) {
...
void selectionSortB(int arr[], int n) {  // selection sort algorithm
  for (int i = 0; i < n; i++) {
    int largest = i;
    for (int j = i; j < n; j++) {
...
void selectionSortAS(int arr[], int n) {  // selection sort algorithm
  steps = 0;
...
void selectionSortBS(int arr[], int n) {  // selection sort algorithm
  steps = 0;
  steps++;  // initial i to 0
  for (int i = 0; i < n; i++) {
    steps += 2;  // for the for loop
