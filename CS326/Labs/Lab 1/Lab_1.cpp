...
int main() {
  ...
  cout << left << setw(20) << "Programmer  " << setw(20) << "Lines of code  "
       << setw(20) << "Lines of comments  " << endl;
  ...
  for (int i = 1; i <= winner; i++) {
    ...
    cout << left << setw(20) << i << " " << setw(20) << Programmers[i - 1].code
         << " " << setw(20) << Programmers[i - 1].comment << endl;
  }
  ...
  cout << endl
       << "It took programmers 1 through " << counter << " to beat programmer "
       << winner << endl;
